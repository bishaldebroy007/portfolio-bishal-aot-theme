        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
              ...
              <div className="text-sm font-mono">
                ...
                {stats.map((stat, index) => (
                  ...
                  >
                    ...
                    <span className="text-gray-400">: </span>
                    <span className="text-aot-red font-bold">
                      &quot;{stat.value}&quot;
                    </span>
            ...
            <motion.div
              ...
              className="p-6 rounded-xl border-3 border-black bg-white"
            >
              <h4 className="font-bold mb-4 text-black text-lg">
                Connect With Me
              </h4>
              <div className="flex flex-wrap gap-3">
                {aboutSocialLinks.map((social, i) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="px-4 py-2 rounded-lg text-sm transition-all duration-300 border-2 border-black text-black hover:bg-black hover:text-white font-bold"
                  >
                    {social.name}
                  </motion.a>
                ))}
